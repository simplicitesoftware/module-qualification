...
public class QualExercise extends ObjectDB {
    ...
    public List<String> preValidate() {
        ...
        if (!isNew()) {
            ...
            if ("ENUM".equals(getFieldValue("qualExAnswerType")) && getField("qualExChoicesEnumeration").hasChanged()) {
                ...
                // if a enum question is used in a question, it can't be updated to prevent an
                ...
                if (isUsed(getRowId())) {
                    ...
                    createListCodesAndVals(flRowId, idChoices, getFieldValue("qualExChoicesEnumeration").split("@@@"),
                            "FRA");
    ...
    public String preCreate() {
        ...
        setFieldValue("qualExId", getFieldValue("qualExType") + "-" + getFieldValue("qualExDifficulty") + "-"
                + getGrant().getNextIdForColumn(getDBName(), "row_id"));
        return null;
    }
    ...
    public String postCreate() {
        ...
        if ("ENUM".equals(getFieldValue("qualExAnswerType"))) {
            ...
            try {
                ...
                /*
                 * String flRowId = createFieldListObjItem(); String idChoices =
                 * getFieldValue("qualExId") + "_CHOICES_ENUM"; String[] enumVals =
                 * getFieldValue("qualExChoicesEnumeration").split("@@@");
                ...
                /*
                 * Original list : Object : QualExUsr Objectfield = qualExamexExId.qualExRefenum
                 * / set : fll_objfield_id Code in Ref list of values / set : fll_code_id
                 * 
                 * Linked list : Object : QualExUsr ObjectField = qualExusrAnswerEnumeration /
                 * set : fll_linked_id Answers list just created / set : fll_list_id
                 */
                ...
                String refOfRowIdSql = "select of.row_id from m_objfield of "
                        ...
                        + "inner join m_field f on of.obf_field_id = f.row_id " + "where OBJ_NAME = 'QualExUsr' "
    ...
    public String preDelete() {
        ...
        try {
            ...
            deleteValuesOfObject("FieldList", new JSONObject().put("lov_name", idChoices).put("row_module_id",
                    ModuleDB.getModuleId("Qualification_Enum")));

            // Delete FieldListCode where lov_name = getFieldValue("qualExId") +
            // "_CHOICES_ENUM"
            deleteValuesOfObject("FieldListCode", new JSONObject().put("lov_code", idChoices).put("row_module_id",
                    ModuleDB.getModuleId("Qualification_Enum")));
    ...
    private void createListCodesAndVals(String flRowId, String idChoices, String[] enumVals, String lang) {
        ...
        for (int i = 0; i < enumVals.length; i++) {
            ...
            AppLog.info(getClass(), "createListCodesAndVals", "Creating list item : " + code.replace(" ", ""),
                    getGrant());
            lcChoice.create();

            ObjectDB flv = g.getTmpObject("FieldListValue");

            String flvEnuRowId = g.simpleQuery("select row_id from m_list_value where lov_code_id = '"
                    + lcChoice.getRowId() + "' and lov_lang='" + lang + "'");
